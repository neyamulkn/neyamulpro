...
class AdsenseController extends Controller
{
    public function index(Request $request)
    {
    	...
    	if ($request->hotlancer_type == "product") {
    		...
    		$products = Product::latest()->take($request->product_count)->get();
    		return view('product',compact('products','column_1','ref_name'));
    	}
    	if ($request->hotlancer_type == "marketplace") {
            ...
            $get_gigs = DB::table('gig_basics')
                ...
                dd($get_gigs);
    		return view('frontend/marketplace', compact('products','column_1','ref_name'));
    	}
