...
@section('title', 'Wokplace Sub Filter')
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title">Sub filter</h4>
					<button type="button" class="close" data-dismiss="modal">&times;</button>	
				</div>

			<form action="{{url('admin/workplace/subfilter')}}" data-parsley-validate method="post" id="profile_info">
				 {{ csrf_field() }}
	        	...
	        	<div class="input-container">
					...
					<label for="Category" class="select-block">
						<select name="filter_id" id="Category">
							...
							<?php
								$get_category = DB::table('workplace_filters')->get();
