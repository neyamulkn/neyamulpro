...
<?php $gig_id = $get_data->gig_id; $gig_url = $get_data->gig_url; ?>
                    ...
                    <div class="rms-content-area"> 
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                  <form action="{{url('dashboard/create-gig')}}" method="post" data-parsley-validate>
                                    {{csrf_field()}}
                                    <input type="hidden" name="slug" value="{{ $get_data->gig_url }}">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="inpt-form-group"> 
                                              <label class="rl-label filter_boreder">Gig Title</label>
                                              <div class="inpt-group">
                                                 <textarea required="required" name="gig_title" style="font-size: 35px !important;height: 115px;" class="inpt-control gig-title-text" type="text" placeholder="do something I'm really good at">{{ $get_data->gig_title }}</textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                              ...
                                              <div class="inpt-group dropdown-select-icon"> 
                                                  ...
                                                  <select name="category_id" required="required" class="inpt-control select " id="category_id">
                                                        ...
                                                        @foreach($get_category as $category)
                                                          <option @if($get_data->category_name == $category->id) selected @endif value="{{$category->id}}">{{$category->category_name}}</option>
                                                        @endforeach
                                                      </select>
                                                  <div class="form-tooltip">
                                                      <span class="tooltip-title">Why do we need this info?</span>
                                         ...
                                         <div class="col-md-6"><br>
                                            <div class="inpt-group dropdown-select-icon"> 
                                                   <select name="subcategory" onchange="get_medata(this.value , {{ $get_data->gig_id }})" required="required" id="subcategory" class="inpt-control select ">

                                                       <option value="{{ $get_data->gig_subcategory }}">{{ $get_data->get_subcategory->subcategory_name }}</option>
                       ...
                       <div class="row">
                          ...
                          <label for="fixedid" class="col-md-6 labbel_box"  onclick="activeButton('fixed')">
                            <div class="p-lg-top-bottom ng-pristine ng-untouched ng-valid eo-button-box eo-button-box-radio ng-not-empty report_hidden <?php if($get_data->gig_payment_type == 'fixed'){echo 'active';} ?>" id="fixed">
                            <span>$$$</span><br/>
                            <span class="m-sm-bottom">Fixed Price</span>
                            <input required="" <?php if($get_data->gig_payment_type == 'fixed'){echo 'checked';} ?> type="radio" id="fixedid" class="labbel_box_radio"  name="gig_payment_type" value="fixed">
                            </div>
                            </label>
                            <label for="monthlyid" class="col-md-6  labbel_box"  for="Intermediate" onclick="activeButton('monthly')">
                              <div class="p-lg-top-bottom ng-pristine ng-untouched ng-valid eo-button-box eo-button-box-radio ng-not-empty report_hidden <?php if($get_data->gig_payment_type == 'monthly'){echo 'active';} ?>" id="monthly">
                              <span>$$$</span><br/>
                              <span class="m-sm-bottom">Monthly Price</span>
                              <input required="" <?php if($get_data->gig_payment_type == 'monthly'){echo 'checked';} ?> type="radio" id="monthlyid" class="labbel_box_radio" name="gig_payment_type"  value="monthly">
                              </div>
                            </label>
                            </div>
                                  ...
                                  <div class="col-md-12">
                                    <div class="inpt-form-group"> 
                                        ...
                                        <div class="inputs">
                                              ...
                                              <input type="text" style="border:none !important;" name="gig_search_tag" value="{{ $get_data->gig_search_tag }}" id="tags-input" data-role="tagsinput" />
                                              </label>
                                        </div>
                                      </div>
                                   </div>
