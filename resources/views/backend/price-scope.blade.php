	...
	<div id="add" class="modal fade" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<form action="{{url('dashboard/marketplace/gig-pricescope')}}" data-parsley-validate method="post" id="profile_info">
					 {{ csrf_field() }}
...
<script type="text/javascript">
	  ...
	  function edit(id){
            var  link = '<?php echo URL::to("dashboard/marketplace/gig-pricescope/edit");?>/'+id;
            $.ajax({
            url:link,
            method:"get",
    ...
    if (confirm("Are you sure delete it.?")) {
            ...
            var  link = '<?php echo URL::to("dashboard/marketplace/gig-pricescope/delete");?>/'+id;
            $.ajax({
            url:link,
            method:"get",
