...
@section('content')
        ...
        <div class="dashboard-content">
            <!-- /HEADLINE -->
			<div class="worklaft1">
				<a href="{{url('dashboard/workplace/job-post/'.$get_job->job_title_slug)}}" class="worklaft1">
			...
			<div class="workr81">
					...
					<div class="workttse222">
						...
						<div class="dddddddtexy">
							...
							<div id="toolbar" style="display: none;">
								...
								<a class="bottomtt" data-wysihtml5-command="italic" title="CTRL+I"><img src="{{asset('/allscript')}}/e/2.png"></a>
								<a class="bottomtt" data-wysihtml5-command="insertUnorderedList"><img src="{{asset('/allscript')}}/e/3.png"></a>
								<a class="bottomtt" data-wysihtml5-command="insertOrderedList"><img src="{{asset('/allscript')}}/e/4.png"></a>
								<a class="bottomtt" data-wysihtml5-command="foreColor" data-wysihtml5-command-value="red"><img src="{{asset('/allscript')}}/e/5.png"></a>
							</div>
						...
						<input type="file" name="file" id="input-file-disable-remove" data-show-remove="false" @if($get_job->file) data-default-file="{{asset('images/workplace/'.$get_job->file) }}" @endif class="dropify" />
				...
				<div class="downloadtheme5">
					<a href="{{url('dashboard/workplace/job-post/'.$get_job->job_title_slug)}}" class="button mid tertiary half v3">Back</a><br>
