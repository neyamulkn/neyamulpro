...
return jQuery;
 ...
 var link_disable = 0;
// this functon work first click open first product
window.onclick = function() {
  var hotlancer_popup = $(".affiliatebyhotlancer").data("hotlancer-popup");
  if( link_disable != 1 && hotlancer_popup == 'on'){
      prduct_link = document.getElementById("url_1").href;
      window.open(prduct_link, '_blank');
      link_disable = 1;
  }
